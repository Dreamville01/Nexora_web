...
const MOCK_PRESS = [
  {
    ...
    quote: 'Nexora is revolutionizing how we think about transparent charitable giving through blockchain technology.',
    date: 'March 2026'
  },
  {
    id: '2',
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center">
          <motion.div initial="hidden" animate="visible" variants={fadeIn}>
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Nexora&apos;s mission is to eliminate the friction, opacity, and high costs of traditional charitable donations by leveraging the power of the Stellar network. We ensure that every cent you give goes directly where it&apos;s needed most.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        ...
        >
          <ImpactStoryCard 
            quote="When the floods hit, we needed funds for water purifiers immediately. Traditional grants take months. Through Nexora, we received USDC in seconds and bought supplies the same day."
