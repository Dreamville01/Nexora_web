...
export const faqData: FAQItem[] = [
  {
    id: 1,
    category: 'donors',
    question: 'How do I make a donation to a project on Nexora?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Nexora accepts donations in any asset available on the Stellar network, including XLM (Lumens), USDC, and other Stellar-based tokens. You can donate using any Stellar wallet that supports the Stellar network, such as Freighter, LOBSTR, or Xellar.',
    relatedArticles: [
      {
        title: 'Supported Assets on Nexora',
  ...
  },
  {
    ...
    answer:
      'Once you connect your Stellar wallet to Nexora, you can view your complete donation history in your profile dashboard. This includes all past donations, transaction hashes, dates, and the projects you\'ve supported. Your donation history is permanently recorded on the Stellar blockchain and can be verified at any time using a Stellar block explorer.',
    relatedArticles: [
      {
  ...
  },
  {
    id: 6,
    category: 'creators',
    question: 'How do I create a fundraising project on Nexora?',
    answer:
  ...
  },
  {
    ...
    answer:
      'No, there are no hidden costs or withdrawal fees. The 2% platform fee is taken from the donation amount at the time of the transaction. When you withdraw funds from your project wallet to your personal Stellar wallet, there are no additional fees charged by Nexora. The only cost is the minimal Stellar network fee for the withdrawal transaction (0.00001 XLM).',
    relatedArticles: [
      {
  ...
  },
  {
    id: 15,
    category: 'fees',
    question: 'How does Nexora compare to other fundraising platforms?',
    answer:
...
export const categoryDescriptions: Record<string, string> = {
  ...
  stellar: 'Technical questions about the Stellar blockchain and how it powers Nexora.',
